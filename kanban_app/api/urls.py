...
from kanban_app.api.views import (BoardDetailView, BoardListView,
                                  CommentOfTasksList, CommentOfTasksListDetail,
                                  EmailCheckView, TaskAssignedToMeView,
...
urlpatterns = [
    ...
    path(
        "tasks/<int:pk>/comments/", CommentOfTasksList.as_view(), name="task-comments"
    ),
    path(
        "tasks/<int:task_id>/comments/<int:pk>/",
        CommentOfTasksListDetail.as_view(),
        name="task-comments-detail",
    ),
    path(
        "tasks/assigned-to-me/",
        TaskAssignedToMeView.as_view(),
